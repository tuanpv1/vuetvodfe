                        ...
                        <div class="tab-content ">
                            <div class="tab-pane fade in active recharge-tab-content" id="tab1">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <form>
                                            <!--<span class="alert bg_green">-->
                                                <!--<i class="fa fa-check-circle" aria-hidden="true"></i>-->
                                                <!--Quý khách đã nạp tiền thành công-->
                                            <!--</span>-->
                                            <!--<span class="alert bg_red">-->
                                                <!--<i class="fa fa-times"></i>-->
                                                <!--Mã thẻ không đúng. Quy khách vui lòng nhập lại.-->
                                            <!--</span>-->
                                            <div class="form-group">
                                                <label for="tvod-code">Mã thẻ cào</label>
                                                <input type="text" class="form-control" id="tvod-code" v-model="tvodCard" placeholder="Nhập mã thẻ cào dịch vụ TVoD">
                                            </div>

                                            <div class="row the-tvod">
                                                <div class="col-md-4">
                                                    <img src="../../static/images/recharge/the-tvod-100.png" class="img-responsive"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <img src="../../static/images/recharge/the-tvod-200.png" class="img-responsive"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <img src="../../static/images/recharge/the-tvod-500.png" class="img-responsive"/>
                                                </div>
                                            </div>
                                            <div class="btn-recharge">
                                                <button type="button" class="btn btn-primary" v-on:click.prevent="processTvodCode(tvodCard)">Xác nhận</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            processTvodCode (tvodCard){
                this.$store
                    .dispatch(RECHARGE_TVOD, {tvodCard})
                    .then(
        ...
        computed: {
            ...mapState({
                errors: state => state.recharge.errors
            }),
            ...mapGetters([
                'currentUser',
                'isAuthenticated'
